...
CREATE TABLE races (id INTEGER PRIMARY KEY UNIQUE NOT NULL, series NOT NULL REFERENCES series (id), year INTEGER NOT NULL, race_file INTEGER NOT NULL UNIQUE, track_id REFERENCES tracks (id) NOT NULL, seqnum, name);